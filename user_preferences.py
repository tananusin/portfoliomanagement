...
def get_user_preferences() -> float:
    ...
    with col1:
        st.markdown("<div style='text-align: left;'>25% (Risk-Off)</div>", unsafe_allow_html=True)
    with col2:
        st.markdown("<div style='text-align: right;'>75% (Risk-On)</div>", unsafe_allow_html=True)
