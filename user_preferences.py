...
def get_user_preferences() -> UserPreference:
    ...
    st.sidebar.caption("ℹ️ Assumed maximum drop each asset class.")
    st.sidebar.markdown("### 📉 Maximum Drawdown (%MDD) ℹ️ *(Used to estimate risk tolerance for each asset class)*")
